 ...
 * @author douglas
 */
public class FrmRegistroTransportador extends javax.swing.JDialog {
    ...
    /**
     * Creates new form FrmRegistroTransportador
     *
     * @param parent
     */
    public FrmRegistroTransportador(Window parent) {
        super(parent, DEFAULT_MODALITY_TYPE);
        initComponents();
        initialize();
    }

    public FrmRegistroTransportador(Window parent, List<Transportador> lista) {
        this(parent);
        this.listaTransportadores = lista;
        this.indexRegistro = -1;
        this.opcao = OPCAO_INSERIR;
    }

    public FrmRegistroTransportador(Window parent, List<Transportador> lista, int indice) {
        this(parent, lista);
        if (indice >= 0 && indice < listaTransportadores.size()) {
            this.indexRegistro = indice;
            this.opcao = OPCAO_ALTERAR;
            this.transportador = listaTransportadores.get(indexRegistro);
            preencherCampos();
        }
    ...
    private void preencherCampos() {
        this.tfNome.setText(transportador.getNome());
        this.tfApelido.setText(transportador.getApelido());
        this.tfPlaca.setText(transportador.getPlaca());
        this.tfTelefone.setText(transportador.getTelefone());
        this.tfCelular.setText(transportador.getCelular());
        this.taObservacoes.setText(transportador.getObservacoes());
    }
    ...
    private void btGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGravarActionPerformed
        ...
        if (this.tfNome.getText().trim().isEmpty()) {
            ...
            FrmTransportadores frmTransportadores = FrmTransportadores.getInstancia();
            frmTransportadores.atualizarTabelaTodos();
