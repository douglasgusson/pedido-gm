 ...
 * @author douglas
 */
public class TransportadorTableModel extends AbstractTableModel {
    ...
    private List<Transportador> dados;

    public TransportadorTableModel(List<Transportador> dados) {
        this.dados = dados;
    }
    ...
    public int getColumnCount() {
        return TransportadorTableModel.COLUMN_COUNT;
    }

    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {

        Transportador obj = dados.get(rowIndex);
    ...
    public Transportador get(int row) {
        return dados.get(row);
    }

    public List<Transportador> getColecao() {
        return dados;
    }
