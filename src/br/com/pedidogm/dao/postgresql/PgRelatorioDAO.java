    ...
    public JasperViewer impressaoPedido(Pedido pedido) {
        ...
        try {
            ...
            String query
                    ...
                    + "     item_pedido_A.\"id_item_pedido\" AS item_pedido_A_id_item_pedido,\n"
                    + "     item_pedido_A.\"id_material\" AS item_pedido_A_id_material,\n"
                    + "     item_pedido_A.\"id_pedido\" AS item_pedido_A_id_pedido,\n"
                    + "     item_pedido_A.\"id_tipo_item\" AS item_pedido_A_id_tipo_item,\n"
                    + "     item_pedido_A.\"quantidade\" AS item_pedido_A_quantidade,\n"
                    + "     item_pedido_A.\"comprimento_br\" AS item_pedido_A_comprimento_br,\n"
                    + "     item_pedido_A.\"altura_br\" AS item_pedido_A_altura_br,\n"
                    + "     item_pedido_A.\"largura_br\" AS item_pedido_A_largura_br,\n"
                    + "     item_pedido_A.\"comprimento_liq\" AS item_pedido_A_comprimento_liq,\n"
                    + "     item_pedido_A.\"altura_liq\" AS item_pedido_A_altura_liq,\n"
                    + "     item_pedido_A.\"largura_liq\" AS item_pedido_A_largura_liq,\n"
                    + "     item_pedido_A.\"acabamento\" AS item_pedido_A_acabamento,\n"
                    + "     item_pedido_A.\"metragem\" AS item_pedido_A_metragem,\n"
                    + "     item_pedido_A.\"valor_unitario\" AS item_pedido_A_valor_unitario,\n"
                    + "     item_pedido_A.\"desconto\" AS item_pedido_A_desconto,\n"
                    + "     item_pedido_A.\"valor_total\" AS item_pedido_A_valor_total\n"
                    + "FROM\n"
                    ...
                    + "     INNER JOIN \"public\".\"item_pedido\" item_pedido_A ON pedido.\"id_pedido\" = item_pedido_A.\"id_pedido\"\n"
                    + "     INNER JOIN \"public\".\"material\" material ON item_pedido_A.\"id_material\" = material.\"id_material\"\n"
                    + "     INNER JOIN \"public\".\"tipo_item\" tipo_item ON item_pedido_A.\"id_tipo_item\" = tipo_item.\"id_tipo_item\"\n"
                    + "     AND item_pedido.\"id_tipo_item\" = tipo_item.\"id_tipo_item\"\n"
                    + "     AND item_pedido.\"id_material\" = material.\"id_material\"\n"
                    + "WHERE\n"
                    + "     pedido.\"id_pedido\" = ?";
